...
case class GoogleTermLinkingToImdb(term: String, filter: Option[GoogleResult => Boolean] = None) extends Task[List[Movie]] with Logging {
  val logID = "GoogleTermLinkingToImdb"
